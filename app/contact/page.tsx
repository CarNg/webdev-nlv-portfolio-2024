        ...
        <div className="z-10 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 w-full sm:w-4/5 md:w-[650px] 2xl:w-full flex-wrap m-auto">
          {data.map((c) => {
            return (
              ...
              >
                <div className="z-10 flex flex-col gap-4 border-white border-solid border-2 rounded-lg p-6 md:p-10 md:min-w-72 md:w-72 md:min-h-72 h-40 md:h-72 justify-center md:items-center break-words link-box">
